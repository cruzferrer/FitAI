  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <MaterialCommunityIcons name="chart-bar" size={60} color={COLORS.accent} style={styles.icon} />
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>Semana 4 de 6 (Fase de Intensificación)</Text>
        </View>
